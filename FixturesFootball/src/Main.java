...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<String> clubs = new ArrayList<>(); // takımların oldugu liste
        ArrayList<String> coupleTeam = new ArrayList<>();// takımların eklendigi arraylist
        int fixtureValue = 0; // o hafta takım sayısına göre kac tane maç olacagını buldugumuz deger
        ...
        public void run () {
            ...
            while (status) {
                ...
                System.out.println("2-Fikstür oluşturma ");
                System.out.println("0- Cıkış");
                System.out.println("------------------")
                int choose = input.nextInt();
                switch (choose) {
                    case 1:
                        System.out.println("Ekmek istedigini takımın adını giriniz:");
                        input.nextLine();
                        String clubName = input.nextLine();
                        clubs.add(clubName);
                        System.out.println("takım adı eklendi " + clubs.get(clubs.size() - 1));
                        System.out.println("----------------");
                        break;
                    ...
                    case 0:
                        ...
                        break;
                    default:
                        System.out.println("Lütfen gecerli bir işlem girin");
